...
export default function About() {
  ...
  return (
    <main className="min-h-dvh w-full flex items-center justify-center bg-white overflow-hidden">
      <section className="w-full max-w-6xl px-6 py-16 text-center">
          ...
          <div className="relative flex items-center justify-center w-full max-w-5xl">
            <AnimatePresence initial={false} mode="popLayout">
              ...
              <motion.div
                ...
                className="absolute z-30 w-full max-w-sm h-[480px] p-8 rounded-3xl shadow-2xl border border-slate-100 bg-white flex flex-col items-center"
              >
                <div className="w-44 h-44 mb-8 overflow-hidden rounded-2xl ring-4 ring-slate-50 shadow-inner">
                  <img src={vps[index].imageUrl} className="w-full h-full object-cover" alt="" />
                </div>
                ...
                <div className="w-10 h-1 bg-cyan-100 mx-auto rounded-full mt-2" />
              ...
              <motion.div
                ...
                transition={cardTransition}
                className="absolute w-64 h-80 border-2 border-slate-200 rounded-3xl overflow-hidden cursor-pointer shadow-lg"
        ...
        <div className="flex justify-center gap-3 mt-12">
          {vps.map((_, i) => (
            <div 
              key={i} 
              className={`h-2.5 rounded-full transition-all duration-300 ${i === index ? "w-10 bg-cyan-600" : "w-2.5 bg-slate-300"}`}
            />
          ))}
        </div>
      </section>
